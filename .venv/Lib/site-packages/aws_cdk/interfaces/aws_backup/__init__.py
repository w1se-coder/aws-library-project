...
for cls in [IBackupPlanRef, IBackupSelectionRef, IBackupVaultRef, IFrameworkRef, ILogicallyAirGappedBackupVaultRef, IReportPlanRef, IRestoreTestingPlanRef, IRestoreTestingSelectionRef]:
